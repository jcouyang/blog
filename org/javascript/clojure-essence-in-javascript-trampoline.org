...
[[*%E7%9B%B8%E4%BA%92%E9%80%92%E5%BD%92(mutual%20recursion)][电梯直达]]
...
比如可以把贩卖机简单的改造一下, 让他返回函数, 而不是直接调用其他函数, 注意第[[(trampoline)][(tampoline)]]行
...
#+HTML: <a class="jsbin-embed" href="http://jsbin.com/cerase/1/embed?js,console">JS Bin</a><script src="http://static.jsbin.com/js/embed.js"></script>
