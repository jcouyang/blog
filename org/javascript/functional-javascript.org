...
#+BEGIN_QUOTE
如果你觉得这本书对你有帮助,不妨请[[https://gum.co/fpjs][我一杯咖啡]], 你将同时获得一本pdf版本的FPJS mini nook
#+END_QUOTE
...
这里的内容完全跟Fogus大师的不一样, 可能比大师的要再"函数式"一些, 用js实现了一些其他函数式语言(Clojure, Haskell)特有的函数式features.
#+END_QUOTE
