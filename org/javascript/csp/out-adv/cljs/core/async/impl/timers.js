...
return cljs.core._write(writer__4360__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var i_23851 = (self__.level + (1));
while(true){
if((i_23851 <= (new_level + (1)))){
(update[i_23851] = self__.header);

var G__23852 = (i_23851 + (1));
i_23851 = G__23852;
continue;
} else {
}
...
var i_23853 = (0);
while(true){
if((i_23853 <= self__.level)){
var links_23854 = (update[i_23853]).forward;
if(((links_23854[i_23853]) === x__$1)){
(links_23854[i_23853] = (x__$1.forward[i_23853]));

var G__23855 = (i_23853 + (1));
i_23853 = G__23855;
continue;
} else {
var G__23856 = (i_23853 + (1));
i_23853 = G__23856;
continue;
}
} else {
...
return cljs.core._write(writer__4360__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3772__auto__,timeout__$1,me){
return (function (){
