#+TITLE: Scala 3 Generalized Algebraic Datatypes (GADT)
#+Date: <2020-03-30 Mon>
#+AUTHOR: 欧阳继超
#+OPTIONS: ^:t
...
#+HTML_HEAD_EXTRA: <meta property="og:title" content="Scala 3 Generalized Algebraic Datatypes" />
...
#+index: Scala!Scala 3 Generalized Algebraic Datatypes
#+index: Dotty!Scala 3 Generalized Algebraic Datatypes
#+index: Phantom Types!Scala 3 Generalized Algebraic Datatypes
#+index: FP!Scala 3 Generalized Algebraic Datatypes
#+index: Catergory Theory!Scala 3 Generalized Algebraic Datatypes
...
但是如果对类型有一些特别的需求, 这种 ADT 就难以满足, 幸运的是 Scala 3 的 enum 本身就是 GADT.
