...
Last section we've seen the usable of [[https://typelevel.org/cats/datatypes/functionk.html][FunctionK]] and [[https://typelevel.org/cats/datatypes/id.html][Id]] in Cats when we were trying to implement [[./rank-n-type.org][rank N types in Scala 2]].
