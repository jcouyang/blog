...
/Phantom Types/ means types that are one the left-hand side, not the right-hand side,
which means the types that you don't actually need, when constructing a value.
