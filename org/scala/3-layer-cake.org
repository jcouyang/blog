...
#+BEGIN_SRC ditaa :file images/readerT-cake.png :exports result
  +--------------+
  |Layer 3:      |
  |     Alg      |
  |              |
...
#+BEGIN_SRC ditaa :file images/free-cake.png :exports result
  +--------------+
  |Layer 3:      |
  |   Program    |
  |              |
...
Whatever your choice is, keep the 3 layer cake in mind, it will always help your structure an extensible,
compoable, testable and scalable project.
